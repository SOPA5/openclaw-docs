<!-- source: https://openclaw-wheat.vercel.app/platforms/linux -->
...
### 2. Debian/Ubuntu (`.deb`)​ (#2-debianubuntu-deb)
...
## ⚙️ 주요 설정 및 팁​ (#️-주요-설정-및-팁)

### 헤드리스(Headless) 모드​ (#헤드리스headless-모드)
