<!-- source: https://openclaw-wheat.vercel.app/gateway/mcp -->
...
## 🏗️ mcporter 런타임​ (#️-mcporter-런타임)

OpenClaw 내부에는 MCP 서버를 구동하고 통신을 중계하는 mcporter라는 전용 런타임이 포함되어 있습니다.

## 🛠️ MCP 서버 추가하기​ (#️-mcp-서버-추가하기)

### 1. 데스크탑 앱에서 추가 (추천)​ (#1-데스크탑-앱에서-추가-추천)
