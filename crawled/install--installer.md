<!-- source: https://openclaw-wheat.vercel.app/install/installer -->
...
## 🛠️ 제공되는 스크립트​ (#️-제공되는-스크립트)

### 1. `install.sh` (macOS/Linux 통합)​ (#1-installsh-macoslinux-통합)
...
### 2. `install.ps1` (Windows PowerShell)​ (#2-installps1-windows-powershell)
