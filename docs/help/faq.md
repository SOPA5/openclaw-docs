...
## ✅ 이 문서를 읽고 나면
- 설치, 채널, 모델, 게이트웨이 문제를 어느 축에서 먼저 확인해야 하는지 빠르게 판단할 수 있습니다.

## ➡️ 다음 단계
- 아직 초기 설정 전이라면 [설치 개요](/install/), 첫 사용 직전이면 [시작하기](/start/getting-started)로 이동하세요.

## 🆘 막히면 여기로
- 여기서도 해결되지 않으면 [피드백 허브](pathname:///feedback)에 증상과 검색어를 남겨주세요.
