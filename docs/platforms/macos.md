...
|---|---|
| 현재 단계 | **Beginner** |
| 읽는 목적 | 맥에서 필요한 준비물을 확인하고 바로 설치하기 |
...
:::tip 💡 공식 권장 방법은?
**설치 스크립트가 1순위**입니다. 가장 먼저 아래 명령어를 보세요:

```bash
curl -fsSL https://openclaw.ai/install.sh | bash
```

Node.js가 이미 준비된 분은 아래의 **npm 직접 설치**도 대안으로 사용할 수 있어요.
:::
...
> 이 방법은 Node.js가 이미 준비된 경우에 잘 맞습니다.
> 처음 설치라면 보통 설치 스크립트가 더 쉽습니다.
