...
Amazon Bedrock는 OpenClaw에서 쓰는 대표적인 Provider 중 하나입니다. 한 줄로 말하면, **AWS 보안과 조직 정책 안에서 운영하기 좋은 제공자**.
...
## 언제 적합한가
- 기업 환경에서 보안과 거버넌스가 중요할 때
- 이미 AWS를 중심으로 운영할 때
- 조직 승인이 필요한 환경일 때

## 설정 흐름
1. AWS 계정과 권한 정책을 준비합니다.
2. Bedrock 사용이 허용된 리전과 권한을 확인합니다.
